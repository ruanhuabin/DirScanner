/*******************************************************************
 *       Filename:  genFilePath.c                                     
 *                                                                 
 *    Description:                                        
 *                                                                 
 *        Version:  1.0                                            
 *        Created:  09/14/2017 04:21:05 PM                                 
 *       Revision:  none                                           
 *       Compiler:  gcc                                           
 *                                                                 
 *         Author:  Ruan Huabin                                      
...
int main(int argc,char *argv[])
{
    ...
    sprintf(commandToRun, "python searchRegularFile.py -i %s/dirs_%d.txt -o %s -p %s_%d", inputDir, myid, outputDir, fileNamePrefix, myid);
